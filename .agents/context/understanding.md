...
├── channels/       # 📱 13 个通道 (WhatsApp, Telegram, Discord, Feishu, WeChat, Slack, Email...)
├── providers/      # 🤖 20+ LLM Provider (OpenRouter, Gemini, Anthropic, DeepSeek, Mistral, Ollama...)
├── bus/            # 🚌 消息路由
├── heartbeat/      # 💓 定时心跳
├── cron/           # ⏰ 定时任务
├── skills/         # 🎯 技能系统
...
**来源：** 基于开源项目 [idurar/idurar-erp-crm](https://github.com/idurar/idurar-erp-crm) (8.3k ⭐, AGPL-3.0, MERN Stack) 二次开发  
**上游最新版本：** v4.1.1 (2026-03-16)，应实时借鉴上游更新和良好经验  
...
- CRM 基于 [idurar-erp-crm](https://github.com/idurar/idurar-erp-crm) 二次开发，应借鉴上游更新
